# coding: utf-8
#
#  Be sure to run `pod spec lint GravtySDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-EOS
  Gravty SDK simplifies integration with Gravty API endpoints by providing wrapper methods to 
  ...
  s.author             = { "Sandeep Pathak" => "sandeep.pathak@lji.io" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.swift_version = '5.0'  
  s.vendored_frameworks = 'GravtySDK/GravtySDK.framework'
end
